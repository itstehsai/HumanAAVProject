...
# Load the datasets
d0 <- Read10X_h5('/Users/arenkiellab/Downloads/5-6 and 6-20 d0 combined_feature_bc_matrix.h5', use.names = TRUE, unique.features = TRUE)
d14u <- Read10X_h5('/Users/arenkiellab/Downloads/5-6 and 6-20 untrans combined_feature_bc_matrix.h5', use.names = TRUE, unique.features = TRUE)
d14BC <- Read10X_h5('/Users/arenkiellab/Downloads/5-6 and 6-20 BC combined_feature_bc_matrix.h5', use.names = TRUE, unique.features = TRUE)
...
Combined_Seurat <- IntegrateData(anchorset = anchors, dims = 1:10)
